...
async def add_dummy_connection(
    ...
    generate_ca_signed_cert(
        server.flaxlight_ca_crt_path.read_bytes(), server.flaxlight_ca_key_path.read_bytes(), dummy_crt_path, dummy_key_path
    )
    ssl_context = ssl_context_for_client(
        server.flaxlight_ca_crt_path, server.flaxlight_ca_key_path, dummy_crt_path, dummy_key_path
    )

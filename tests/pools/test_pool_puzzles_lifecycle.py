...
from flaxlight.wallet.puzzles.p2_conditions import puzzle_for_conditions
from flaxlight.wallet.puzzles import singleton_top_layer
from flaxlight.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - flaxlight.pools.pool_puzzles.py
    - flaxlight.wallet.puzzles.pool_member_innerpuz.clvm
    - flaxlight.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""

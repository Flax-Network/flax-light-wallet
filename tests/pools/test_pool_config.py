...
from flaxlight.pools.pool_config import PoolWalletConfig
from flaxlight.util.config import load_config, save_config, create_default_flaxlight_config
...
def test_pool_config():
    ...
    create_default_flaxlight_config(test_root, ["config.yaml"])

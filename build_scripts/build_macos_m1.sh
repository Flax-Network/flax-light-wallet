...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Flax\ Light\ Wallet-darwin-arm64/Flax\ Light\ Wallet.app --platform=darwin \
...
mv Flax\ Light\ Wallet-darwin-arm64 ../../../build_scripts/dist/
cd ../../../build_scripts || exit

DMG_NAME="FlaxLight-$FLAX_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Flax\ Light\ Wallet-darwin-arm64/Flax\ Light\ Wallet.app Flax-$FLAX_INSTALLER_VERSION-arm64 \

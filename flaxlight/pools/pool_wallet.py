...
from flaxlight.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from flaxlight.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from flaxlight.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from flaxlight.pools.pool_puzzles import (
...
from flaxlight.util.ints import uint8, uint32, uint64
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `flaxlight singleton` that is

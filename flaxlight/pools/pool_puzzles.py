...
from flaxlight.clvm.singleton import SINGLETON_LAUNCHER
from flaxlight.consensus.block_rewards import calculate_pool_reward
from flaxlight.consensus.coinbase import pool_parent_id
from flaxlight.pools.pool_wallet_info import PoolState, LEAVING_POOL, SELF_POOLING
...
from flaxlight.wallet.puzzles.singleton_top_layer import puzzle_for_singleton
...
def solution_to_pool_state(full_spend: CoinSpend) -> Optional[PoolState]:
    ...
    if num_args == 2:
        ...
        # This is referred to as p1 in the flaxlightlisp code

...
from flaxlight.pools.pool_config import PoolWalletConfig, load_pool_config
from flaxlight.protocols import farmer_protocol, harvester_protocol
from flaxlight.protocols.pool_protocol import (
    ErrorResponse,
...
from flaxlight.server.server import ssl_context_for_root
...
from flaxlight.util.bech32m import decode_puzzle_hash
from flaxlight.util.byte_types import hexstr_to_bytes
from flaxlight.util.config import load_config, save_config, config_path_for_filename
...
from flaxlight.wallet.puzzles.singleton_top_layer import SINGLETON_MOD
...
class Farmer:
    ...
    async def setup_keys(self):
        ...
        if len(self.get_public_keys()) == 0:
            error_str = "No keys exist. Please run 'flaxlight keys generate' or open the UI."

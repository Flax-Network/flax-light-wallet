...
from flaxlight.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if matched:
                ...
                if "flaxlight" in cc_discrepancies:
                    cc_discrepancies["flaxlight"] = cc_discrepancies["flaxlight"] + diff
                else:
                    cc_discrepancies["flaxlight"] = diff

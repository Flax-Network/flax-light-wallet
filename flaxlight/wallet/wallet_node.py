...
from flaxlight.consensus.find_fork_point import find_fork_point_in_chain
from flaxlight.daemon.keychain_proxy import (
...
from flaxlight.full_node.weight_proof import chunks
from flaxlight.protocols import wallet_protocol
from flaxlight.protocols.full_node_protocol import RequestProofOfWeight, RespondProofOfWeight
from flaxlight.protocols.protocol_message_types import ProtocolMessageTypes
from flaxlight.protocols.wallet_protocol import (
...
from flaxlight.server.node_discovery import WalletPeers
...
from flaxlight.types.weight_proof import WeightProof, SubEpochData
from flaxlight.util.byte_types import hexstr_to_bytes
from flaxlight.util.ints import uint32, uint64
from flaxlight.util.keychain import KeyringIsLocked
from flaxlight.util.path import mkdir, path_from_root
from flaxlight.wallet.block_record import HeaderBlockRecord
...
from flaxlight.wallet.util.wallet_sync_utils import (
    validate_additions,
    validate_removals,
...
class WalletNode:
    ...
    async def get_key_for_fingerprint(self, fingerprint: Optional[int]) -> Optional[PrivateKey]:
        try:
            ...
            self.log.warning("No keys present. Create keys with the UI, or with the 'flaxlight keys' program.")
            return None
    ...
    async def untrusted_sync_to_peer(
        self, peer: WSFlaxConnection, weight_proof: WeightProof, syncing: bool, fork_height: int
    ):
        assert self.wallet_state_manager is not None

...
from flaxlight.cmds.units import units
...
from flaxlight.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total flaxlight farmed: {amounts['farmed_amount'] / units['flaxlight']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['flaxlight']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['flaxlight']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'flaxlight start wallet' and 'flaxlight wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'flaxlight wallet show'")
    else:
        print("Note: log into your key using 'flaxlight wallet show' to see rewards for each key")

...
from flaxlight.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic, unlocks_keyring
...
def generate_and_print():
    ...
    print(mnemonic)
    print("Note that this key has not been added to the keychain. Run flaxlight keys add")
    return mnemonic

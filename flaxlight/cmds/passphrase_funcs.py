...
from flaxlight.daemon.client import acquire_connection_to_daemon
from flaxlight.util.keychain import Keychain, obtain_current_passphrase, supports_os_passphrase_storage
...
from flaxlight.util.ws_message import WsRpcMessage
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'flaxlight passphrase set' or 'flaxlight passphrase remove' to update or remove your passphrase")
        sys.exit(1)

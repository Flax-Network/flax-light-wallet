...
from flaxlight.util.ssl_check import DEFAULT_PERMISSIONS_CERT_FILE, DEFAULT_PERMISSIONS_KEY_FILE
...
def get_flaxlight_ca_crt_key() -> Tuple[Any, Any]:
    crt = pkg_resources.resource_string(__name__, "flaxlight_ca.crt")
    key = pkg_resources.resource_string(__name__, "flaxlight_ca.key")
    return crt, key
...
def main():
    return make_ca_cert(Path("./flaxlight_ca.crt"), Path("./flaxlight_ca.key"))
